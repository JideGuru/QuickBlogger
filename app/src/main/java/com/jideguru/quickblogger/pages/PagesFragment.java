package com.jideguru.quickblogger.pages;
...
public class PagesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        API_LINK = "https://www.googleapis.com/blogger/v3/blogs/"+blogId+"/pages?access_token="+idToken+"&maxResults=100";

        Log.i("URILINK", API_LINK);
        recyclerView= (RecyclerView) view.findViewById(R.id.pages_contain);
